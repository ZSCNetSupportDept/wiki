...
<img style="display:block;width:100%;max-width:100%;" src="/uploads/651-overview.png" />
</div>

<div class="overview-main" style="display: flex; flex-direction: column;padding:10px 5px 0 5px;">
<div class="overview-item" style="display: flex;">
<p style="flex:0 0 100px;font-weight: 600;">故障名称</p>
<p>物理连接错误</p>
</div>

<div class="overview-item" style="display: flex;">
<p style="flex:0 0 100px;font-weight: 600;">故障代码</p>
<p>651</p>
</div>

<div class="overview-item" style="display: flex;">
<p style="flex:0 0 100px;font-weight: 600;">所属运营商</p>
<p>移动、联通</p>
</div>
</div>
</div>
